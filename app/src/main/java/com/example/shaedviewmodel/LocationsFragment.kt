...
import com.example.shaedviewmodel.databinding.FragBakersLocationBinding


class LocationsFragment : Fragment() {
    lateinit var model: SharedViewModel
    private lateinit var binding: FragBakersLocationBinding
    ...
    override fun onCreateView(
        ...
        binding = FragBakersLocationBinding.inflate(inflater, container, false)
    ...
    //CHOOSE LOCATIONS FRAGMENT
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        model = ViewModelProvider(requireActivity()).get(SharedViewModel::class.java)

        binding.btnNext.setOnClickListener {
            model.sendLocation(location) // <<-- location variable has value of selected radioButton's item like "Gulshan"
    ...
    fun addFrag(){
        ...
        // Create new fragment and transaction
        val newFragment: Fragment = SummaryFragment()
